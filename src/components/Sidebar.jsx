...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen text items-center align-end bg-transparent z-10000 w-[15rem]">
      <div className="pl-1 h-[70vh] overflow-auto bg-gradient-to-b from-blue-400 to-blue-900 mr-6 rounded-tr-3xl rounded-br-3xl ml-0" style={{ paddingRight: '60px' }}>
       
          <>
          <div className='align-end items-end'>
            <div className="flex justify-between items-center ">
              <Link to="/" className="items-center gap-3 ml-5 mt-4 flex text-xl font-extrabold tracking-tight text-white ">
